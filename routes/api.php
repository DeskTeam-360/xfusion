...
Route::prefix('v1')->middleware('fusion.api')->group(function () {
    ...
    $registerQbrRoutes = function (): void {
        ...
        Route::get('/{qbr}/arp-objectives', [QbrController::class, 'arpObjectives']);
    ...
    $registerIrrRoutes = function () {
        ...
        Route::post('/{irr}/assessment/generate', [IrrController::class, 'generateAssessment']);
    ...
    $registerArrRoutes = function (): void {
        ...
        Route::post('/{arr}/evidence/generate', [ArrController::class, 'generateEvidence']);
        Route::get('/{arr}/evidence', [ArrController::class, 'getEvidence']);
        Route::get('/{arr}/dashboard', [ArrController::class, 'getDashboard']);
        Route::post('/{arr}/assessment/generate', [ArrController::class, 'generateAssessment']);
        ...
        Route::get('/{arr}/recommendations', [ArrController::class, 'getRecommendations']);
