<x-admin-layout>
    <div class="container full-container py-5">
        ...
        <div class="px-5">
            <h1 class="mb-6 text-2xl font-semibold text-dark dark:text-white">Course scoring — new group</h1>
            <p class="mb-6 max-w-prose text-sm text-dark/75 dark:text-darklink">
