...
function get_company_info()
{
    ...
    $arrayLinks = ["https://demo.xperiencefusion.com/lms-home-screen/", "https://demo.xperiencefusion.com/transform/transform-menu/", "https://demo.xperiencefusion.com/transform/transform-menu/introduction-level-1/"];
    ...
    if (!$limitLinks) {
        ...
        if ($userID != null) {
            ...
            $temp_data2 = $url;
            $wpdb->query($wpdb->prepare("INSERT INTO logs (log, text) VALUES (%s, %s)", $temp_data2, 'ini_url_no_list'));
